				...
				<div className='about-page__wrapper'>
					<div className='about-page__block'>
						...
						<p className='about-page__paragraph'>
							Я начинающий программист из города Санкт-Петербурга, Россия. Мне
							интересно всё, что связано с IT-технологиями. В данный момент я
							активно изучаю веб-разработку. Хотя сейчас я знаю не очень много,
							но стараюсь не стоять на месте и постоянно учиться, узнавать
							новое.
						</p>
					</div>
					<AboutIllustration />
